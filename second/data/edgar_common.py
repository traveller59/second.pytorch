...
def edgar_area(boxes, add1=False):
...
def edgar_intersection(boxes1, boxes2, add1=False):
...
def edgar_iou(boxes1, boxes2, add1=False):
    ...
    """
    intersect = edgar_intersection(boxes1, boxes2, add1)
    area1 = edgar_area(boxes1, add1)
    area2 = edgar_area(boxes2, add1)
...
def _check_edgar_directory(root_path):
...
def get_edgar_image_info(path,
    ...
    KITTI annotation format version 2:
    {
        ...
        annos: {
            ...
            [optional]difficulty: edgar difficulty
...
def filter_edgar_anno(image_anno,
                      used_classes,
    ...
    if 'DontCare' in used_classes and dontcare_iou is not None:
        ...
        ious = edgar_iou(all_boxes, all_boxes[dont_care_indices])
...
def edgar_result_line(result_dict, precision=4):
...
def annos_to_edgar_label(annos):
    ...
    for i in range(num_instance):
        ...
        line = edgar_result_line(result_dict)
