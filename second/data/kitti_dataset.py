...
def create_reduced_point_cloud(data_path,
    ...
    _create_reduced_point_cloud(data_path, train_info_path, save_path, use_disparity=use_disparity)
    _create_reduced_point_cloud(data_path, val_info_path, save_path, use_disparity=use_disparity)
    _create_reduced_point_cloud(data_path, test_info_path, save_path, use_disparity=use_disparity)
    if with_back:
        _create_reduced_point_cloud(
            data_path, train_info_path, save_path, back=True, use_disparity=use_disparity)
        _create_reduced_point_cloud(
            data_path, val_info_path, save_path, back=True, use_disparity=use_disparity)
        _create_reduced_point_cloud(
            data_path, test_info_path, save_path, back=True, use_disparity=use_disparity)
