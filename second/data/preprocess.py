...
def prep_pointcloud(input_dict,
    ...
    if create_targets:
        ...
        metrics["assign_time"] = time.time() - t1
        metrics["prep_time"] = time.time() - t
        """
